...
# Importa funciones para ver jugar al modelo DQN en modo self-play o vs random
from rl_tennis_pz.evaluation import (  # noqa: E402
    watch_dqn_selfplay,
    watch_dqn_vs_random,
)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Ver jugar al modelo DQN en Tennis (self-play o vs random)"
    )
    parser.add_argument(
        "--model-path",
        type=str,
        default="models/dqn_tennis_selfplay.zip",
        help="Ruta del modelo DQN a evaluar (archivo .zip de SB3).",
    )
    parser.add_argument(
        "--episodes",
        type=int,
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Ruta de salida para grabar video (ej: videos/dqn_selfplay.mp4).",
    )
